        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="flex flex-col space-y-6">
                ...
                <div class="flex flex-col space-y-2 items-center">
                    <h1 class="font-extrabold text-2xl">{{ __('Buat Akun Baru') }}</h1>
                    <div class="text-gray-500 text-sm text-center">
                        <p>{{ __('Daftar untuk mulai menggunakan aplikasi kasir!') }}</p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <x-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Jhon Doe" >
                ...
                <div>
                    ...
                    <x-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autocomplete="username" placeholder="jhondoe@gmail.com" >
                    ...
                    <x-label for="password_confirmation" value="{{ __('Konfirmasi Password') }}" />
                       <x-input id="password_confirmation" class="block mt-1 w-full" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Re-enter password" >
                        <x-hugeicons-lock-key class="w-[1.1rem] h-[1.1rem]" />
                                      ...
                                      <!-- Show/Hide Password Button -->
                       <button type="button" class="absolute inset-y-0 right-0 pr-3 pt-6 flex items-center text-gray-500"
                           onclick="togglePassword('password_confirmation', 'show-icon-confirm', 'hide-icon-confirm')">
                           ...
                           <svg id="hide-icon-confirm" xmlns="http://www.w3.org/2000/svg" fill="none" height="20" viewBox="0 0 24 24"
                           width="20">
                           <g fill="#292d32">
                               <path
                                   d="m9.46992 15.2799c-.19 0-.38-.07-.53-.22-.82-.82-1.27-1.91-1.27-3.06 0-2.38998 1.94-4.32998 4.32998-4.32998 1.15 0 2.24.45 3.06 1.27.14.14.22.33.22.53s-.08.39-.22.53l-5.05998 5.05998c-.15.15-.34.22-.53.22zm2.52998-6.10998c-1.56 0-2.82998 1.26998-2.82998 2.82998 0 .5.13.98.37 1.4l3.85998-3.85998c-.42-.24-.9-.37-1.4-.37z" />
                    ...
                    <div>
                        <x-label for="terms">
                            <div class="flex items-center">
                                ...
                                <div class="ms-2 text-gray-600 text-sm">
                                    {!! __('Saya setuju dengan :terms_of_service dan :privacy_policy', [
                                            'terms_of_service' => '<a target="_blank" href="'.route('terms.show').'" class="underline text-gray-600 hover:text-gray-900 rounded-md">'.__('Ketentuan Layanan').'</a>',
                                            'privacy_policy' => '<a target="_blank" href="'.route('policy.show').'" class="underline text-gray-600 hover:text-gray-900 rounded-md">'.__('Kebijakan Privasi').'</a>',
                                    ]) !!}
                                </div>
                            </div>
                        </x-label>
